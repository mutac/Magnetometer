...
public:
  void Sharing()
  {
    ...
    CFIX_ASSERT (c1.getRefCount() == 1);
    CFIX_ASSERT (c2.getRefCount() == 1);
    ...
    CFIX_ASSERT (c1.getRefCount() == 2);
    CFIX_ASSERT (c2.getRefCount() == 2);
    CFIX_ASSERT (blackSheep1.getRefCount() == 2);
    CFIX_ASSERT (blackSheep2.getRefCount() == 2);

    // Copy construct
    SharedCount c3(c1);
    CFIX_ASSERT (c1 == c3 && c2 == c3);
    CFIX_ASSERT (c1.getRefCount() == 3);
    CFIX_ASSERT (c2.getRefCount() == 3);
    CFIX_ASSERT (c3.getRefCount() == 3);

    // Lifetime
    {
      SharedCount c4(c3);
      CFIX_ASSERT (c1 == c4 && c2 == c4 && c3 == c4);
      CFIX_ASSERT (c1.getRefCount() == 4);
      CFIX_ASSERT (c2.getRefCount() == 4);
      CFIX_ASSERT (c3.getRefCount() == 4);
      CFIX_ASSERT (c4.getRefCount() == 4);
    }
